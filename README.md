...
`SQUID_DISCORD_TOKEN`, `SQUID_API_SECRET`, `SQUID_API_KEY_PEPPER`, `SQUID_API_SESSION_PEPPER`,
`SQUID_API_IDEMPOTENCY_ACTIVE_KEY_ID`, and `SQUID_API_IDEMPOTENCY_KEYS`. Exported environment
...
| `LOG_DIR` / `LOG_LEVEL` / `ROOT_LOG_LEVEL` | `SQUID_LOG_DIRECTORY` / `SQUID_LOG_LEVEL` / `SQUID_LOG_ROOT_LEVEL` |
