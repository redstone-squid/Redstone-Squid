...
@command(description='Invite me to your other servers!')
...
@command(description=f'Link to {BOT_NAME}\'s source code.')
async def source_code(ctx: Context):
    await ctx.send(f'Source code can be found at: {SOURCE_CODE_URL}.')


@command(description='Links you to our record submission form.')
...
# @command(name='help', description='Shows help messages.')
