...
from squid_layouts.discord.navigation_controls import NavigationContext, page_select_nav
...
def test_tabs_router_shell_encodes_next_state_and_input_state() -> None:
    ...
    scene = sl.planning.plan(rendered, target=sl.discord.V2_TARGET).scene
    ...
    routed_scene = sl.planning.plan(routed, target=sl.discord.V2_TARGET).scene
