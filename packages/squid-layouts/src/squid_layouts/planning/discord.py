...
) -> Target[V2Limits, SceneComponentsV2, ComponentsV2Target, AdapterT]:
...
) -> Target[ClassicLimits, SceneClassicMessage, ClassicTarget, AdapterT]:
...
) -> Target[V2Limits, SceneComponentsV2, ComponentsV2Target, Any]:
...
) -> Target[ClassicLimits, SceneClassicMessage, ClassicTarget, Any]:
    """Explicit gradual-typing escape hatch for runtime-selected adapters."""
