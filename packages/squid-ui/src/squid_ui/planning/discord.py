...
from squid_ui.planning.classic import CLASSIC_DIALECT
...
from squid_ui.planning.v2 import V2_DIALECT
from squid_ui.target_types import ClassicTarget, ComponentsV2Target, DiscordAdapter
