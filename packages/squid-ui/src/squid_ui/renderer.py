...
class Renderer[BodyT: scene.Body, OutputT](Protocol):
    ...
    `Document` here made the protocol unsatisfiable: parameters are contravariant, so
    ...
    def draw(self, document: scene.Document[BodyT], *, plan: PlanResult[BodyT] | None = None) -> OutputT: ...
