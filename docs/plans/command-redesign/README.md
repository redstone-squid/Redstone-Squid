...
| 6 | 06-build.md (todo) | `/build`, 15 commands: one edit surface instead of two that disagree about who may edit; `queue` paginated and de-idded; the loose schematic tools moved under `build schematic` | Not started |
...
| C6 | Ad-hoc pagination | Phase 5.6, which is where the shared paginator lands; phases 6–9 use it rather than reinventing one each |
