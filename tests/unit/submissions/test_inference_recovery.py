...
async def test_retry_uses_saved_model_and_original_message_facts() -> None:
    ...
    service = SubmissionInferenceRuns(cast(Any, repository), cast(Any, inference), cast(Any, object()))
...
async def test_completed_run_does_not_invoke_model_or_read_private_images() -> None:
    ...
    service = SubmissionInferenceRuns(cast(Any, repository), cast(Any, object()), cast(Any, object()))
