...
_SUBMISSION_REFERENCES = (
    ...
    _AccountReference("submission_inference_runs", "owner_account_id"),
    _AccountReference("submission_revision_proposals", "owner_account_id"),
    _AccountReference("submission_revision_proposals", "requested_by_account_id"),
    _AccountReference("submission_revision_proposals", "approved_by_account_id"),
