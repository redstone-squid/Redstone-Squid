        ...
        FormSection(
            ...
            fields=(
                ...
                FormField(
                    ...
                    required=True,
                    repeatable=True,
                    constraints=FieldConstraints(min_items=1, max_items=20),
        ...
        FormSection(
            ...
            fields=(
                FormField(
                    ...
                    constraints=FieldConstraints(max_items=40),
                ),
                FormField(
                    ...
                    value_kind=ValueKind.STRING_LIST,
                    repeatable=True,
                    constraints=FieldConstraints(max_items=5),
                    required_capability="repeatable_text",
                ),
                FormField(
                    id="showcase_tags",
    ...
    return FormSection(
        ...
        fields=(
            FormField(
                ...
                constraints=FieldConstraints(max_items=20),
            ),
            FormField(
